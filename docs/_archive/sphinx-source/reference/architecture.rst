...
::
   ...
   ├── platform/mcp/          # @graphhunter/mcp — MCP server for AI assistants (uses app HTTP API)
   │                          # graph-hunter-mcp/ retained one release cycle for 1.3.0 pins
