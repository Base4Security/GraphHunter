...
#[tauri::command]
pub fn cmd_load_session(state: State<Arc<AppState>>, session_id: String) -> Result<SessionInfo, CommandError> {
...
#[tauri::command]
pub fn cmd_save_session(state: State<Arc<AppState>>, session_id: Option<String>) -> Result<(), CommandError> {
    let id = session_id
        .or_else(|| {
            state
                .current_session_id
